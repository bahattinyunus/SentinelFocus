        ...
        <main className="min-h-screen bg-neutral-950 text-white p-6 font-sans">
            ...
            >
                <div className="text-center">
                    ...
                    <h2 className="text-4xl font-bold tracking-tighter text-cyan-400">PRIVACY SHIELD ACTIVE</h2>
                    <p className="text-neutral-400 mt-2">Unrecognized personnel detected in proximity.</p>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <header className="flex justify-between items-end border-b border-neutral-800 pb-6">
                    <div>
                        ...
                        <p className="text-neutral-500 text-sm font-mono tracking-widest uppercase mt-1">Status: {state.active ? "NOMINAL" : "INITIALIZING"}</p>
                    </div>
                    <div className="flex gap-4">
                        <div className="bg-neutral-900 border border-neutral-800 px-4 py-2 rounded-lg flex items-center gap-3">
                            ...
                            <span className="text-xs font-mono">CORE_AI</span>
                        </div>
                    </div>
                </header>
                    ...
                    <div className="lg:col-span-2 space-y-4">
                            ...
                            <div className="absolute bottom-4 right-4 flex gap-2">
                                {state.phoneDetected && (
                                    <div className="bg-red-500/20 text-red-400 border border-red-500/50 px-3 py-1.5 rounded-md text-xs font-bold animate-bounce flex items-center gap-2">
                                        <AlertTriangle className="w-3 h-3" /> DISTRACTION_DETECTED
                                    </div>
                                )}
                                {state.isSlouching && (
                                    <div className="bg-orange-500/20 text-orange-400 border border-orange-500/50 px-3 py-1.5 rounded-md text-xs font-bold flex items-center gap-2">
                                        <Eye className="w-3 h-3" /> POSTURE_WARNING
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-neutral-900 p-6 rounded-2xl border border-neutral-800 hover:border-neutral-700 transition-colors">
                                <p className="text-neutral-500 text-[10px] font-mono uppercase tracking-[0.2em]">Efficiency Score</p>
                                <h3 className="text-4xl font-bold mt-1 text-white">94<span className="text-sm font-normal text-neutral-500 ml-1">%</span></h3>
                            </div>
                            <div className="bg-neutral-900 p-6 rounded-2xl border border-neutral-800 hover:border-neutral-700 transition-colors">
                                <p className="text-neutral-500 text-[10px] font-mono uppercase tracking-[0.2em]">Session Time</p>
                    ...
                    <section className="space-y-6">
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-3xl">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text font-bold uppercase tracking-widest text-sm">Security Protocols</h3>
                            </div>

                            <ul className="space-y-4">
                                {[
                                    { label: "Privacy Shield", active: state.multiplePeople, color: "text-cyan-400" },
                                    { label: "Phone Detector", active: state.phoneDetected, color: "text-red-400" },
                                    { label: "Ergo-Scanner", active: true, color: "text-green-400" },
                                    { label: "Local-Only Encryption", active: true, color: "text-blue-400" }
                                ].map((item, idx) => (
                        ...
                        <div className="bg-neutral-900 p-6 rounded-3xl border border-neutral-800">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text font-bold uppercase tracking-widest text-sm">Deep Work Log</h3>
                            </div>
                            <div className="space-y-3">
                                <div className="h-2 w-full bg-neutral-800 rounded-full overflow-hidden">
                                    <div className="h-full bg-purple-500 w-3/4" />
                                </div>
                                <p className="text-[10px] text-neutral-500 font-mono">DAILY_TARGET: 75% ACHIEVED</p>
                            </div>
                        </div>
                    </section>
                </div>
